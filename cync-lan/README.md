>[!IMPORTANT]
> DNS redirection is REQUIRED, please see [here](https://github.com/baudneo/hass-addons/tree/dev/docs/DNS.md) for documentation and examples
...
# Supported devices
See [known devices](https://github.com/baudneo/hass-addons/tree/dev/docs/known_devices.md)
