...
```python
## File: tests/cync_controller/unit/test_mqtt_group_commands.py
...
```python
## File: tests/cync_controller/integration/test_cloud_relay.py
...
```python
## File: tests/cync_controller/unit/test_periodic_tasks.py
