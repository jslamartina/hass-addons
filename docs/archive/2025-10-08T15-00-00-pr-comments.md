...
### File: `cync-lan/config.yaml` (Line 39)
...
### File: `cync-lan/config.yaml` (Lines 44-45)
...
### File: `cync-lan/config.yaml.backup`
...
### File: `cync-lan/Dockerfile` (Lines 38-39)
...
### File: `cync-lan/static/index.html` (Line 142)
