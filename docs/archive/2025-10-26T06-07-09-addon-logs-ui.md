...
1. **Verify journald is accessible:**
...
1. **Verify systemd-journal-remote is installed:**
...
_Related Issue: Add-on logs not appearing in UI due to missing journald configuration_
