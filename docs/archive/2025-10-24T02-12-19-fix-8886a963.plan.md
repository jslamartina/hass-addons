# 2025 10 24T02 12 19 Fix 8886A963.Plan
...
- Completed: Clean MQTT rediscovery using `scripts/delete_mqtt_safe.py`.
...
1. Publish plain ON/OFF for switches
...
1. Map switch → group (optional convenience)
...
- For schema changes, clear stale entities (`scripts/delete_mqtt_safe.py`) and restart add-on.
