...
from .test_helpers import create_packet
...
class TestCyncTCPDevicePacketParsing:
    ...
    @pytest.mark.asyncio
    async def test_parse_packet_0x83_firmware_version(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_parse_packet_0x83_internal_status(self) -> None:
