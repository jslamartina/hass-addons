...
def test_packet_observer_protocol_structural_subtyping() -> None:
    ...
    class ValidObserver:
        ...
        def on_packet_received(self, _direction: PacketDirection, _data: bytes, _connection_id: int) -> None:
            """Handle received packet."""

        def on_connection_established(self, _connection_id: int) -> None:
            """Handle connection establishment."""

        def on_connection_closed(self, _connection_id: int) -> None:
