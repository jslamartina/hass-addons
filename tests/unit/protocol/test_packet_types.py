...
from tests.fixtures.real_packets import HANDSHAKE_0x23_DEV_TO_CLOUD, HELLO_ACK_0x28_CLOUD_TO_DEV, PacketMetadata
...
def test_packet_type_constants(constant_name: str, expected_value: int) -> None:
    ...
    actual_value = int(cast(int, globals()[constant_name]))
