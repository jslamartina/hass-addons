...
from cync_controller.protocol.checksum import calculate_checksum_between_markers, insert_checksum_in_place
...
def test_checksum_too_short_packet() -> None:
    ...
    with pytest.raises(ValueError, match="too short"):
        _ = calculate_checksum_between_markers(short_packet)
...
def test_checksum_edge_case_empty_slice() -> None:
    ...
    with pytest.raises(ValueError, match="too short"):
        _ = calculate_checksum_between_markers(edge_case_packet)
...
def test_checksum_no_start_marker() -> None:
    ...
    with pytest.raises(ValueError, match="subsection not found"):
        _ = calculate_checksum_between_markers(packet_no_marker)
