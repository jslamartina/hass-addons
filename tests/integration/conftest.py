...
class MockTCPServer:
    ...
    def __init__(
        ...
        self._should_accept_connection: bool = True
    ...
    async def _handle_client(
        ...
        addr = cast(tuple[str, int] | None, writer.get_extra_info("peername"))
...
def pytest_terminal_summary(
    ...
    """Display performance report at end of test session."""
    del exitstatus
    # Get the performance tracker from the session
    tracker = cast(PerformanceTracker | None, getattr(config, "_performance_tracker", None))
