...
class CyncCloudAPI:
    ...
    _instance: ClassVar[CyncCloudAPI | None] = None
    ...
    def __init__(self, **kwargs: object) -> None:
        ...
        """
        self.api_timeout: int = 8
        self.lp: str = "CyncCloudAPI"
        self.auth_cache_file: str = CYNC_CLOUD_AUTH_PATH
        self.token_cache: ComputedTokenData | None = None
        self.http_session: aiohttp.ClientSession | None = None

        # Initialize token-related state
        self.access_token: str | None = None
        self.user_id: str | int | None = None
        self.expire_in: str | int | None = None
        self.refresh_token: str | None = None
        self.authorize: str | None = None
        self.issued_at: datetime.datetime | None = None
    ...
    def _parse_token_fields(self, raw_dict: dict[str, object]) -> ComputedTokenData | None:
        ...
        access_token_val: object | None = raw_dict.get(TOKEN_FIELD_NAMES["access"])
        user_id_val: object | None = raw_dict.get(TOKEN_FIELD_NAMES["user_id"])
        expire_in_val: object | None = raw_dict.get(TOKEN_FIELD_NAMES["expire_in"])
        refresh_token_val: object | None = raw_dict.get(TOKEN_FIELD_NAMES["refresh"])
        authorize_val: object | None = raw_dict.get(TOKEN_FIELD_NAMES["authorize"])
        issued_at_val: object | None = raw_dict.get(TOKEN_FIELD_NAMES["issued_at"])
    ...
    async def read_token_cache(self) -> ComputedTokenData | None:
        ...
        auth_file = Path(self.auth_cache_file)

        def _read_json() -> ComputedTokenData | None:
            """Read JSON token cache synchronously (runs in thread pool)."""
            ...
            try:
                ...
                logger.warning(
                    ...
                    extra={"lp": lp, "error": str(exc), "error_type": type(exc).__name__},
                )
                return None
            ...
            issued_at_val: object | None = raw_dict.get(TOKEN_FIELD_NAMES["issued_at"])
            if isinstance(issued_at_val, str):
                raw_dict[TOKEN_FIELD_NAMES["issued_at"]] = datetime.datetime.fromisoformat(issued_at_val)
    ...
    def _parse_token_response(
        ...
        access_token_val: object | None = token_data.get(TOKEN_FIELD_NAMES["access"])
        user_id_val: object | None = token_data.get(TOKEN_FIELD_NAMES["user_id"])
        expire_in_val: object | None = token_data.get(TOKEN_FIELD_NAMES["expire_in"])
        refresh_token_val: object | None = token_data.get(TOKEN_FIELD_NAMES["refresh"])
        authorize_val: object | None = token_data.get(TOKEN_FIELD_NAMES["authorize"])
