...
# Prefer loopback by default; allow explicit override via env when intentionally exposing.
_cync_srv_host_env = os.environ.get("CYNC_SRV_HOST")
CYNC_SRV_HOST: str = _cync_srv_host_env if _cync_srv_host_env else "127.0.0.1"
