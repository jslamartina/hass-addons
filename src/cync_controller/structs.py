...
class GlobalObject:
    ...
    tasks: ClassVar[list[asyncio.Task[object]]] = []
    ...
    def __new__(cls, *_args: object, **_kwargs: object) -> GlobalObject:
    ...
    def reload_env(self):
        ...
        self.env.cync_srv_host = os.environ.get("CYNC_SRV_HOST", CYNC_SRV_HOST)
...
class Tasks:
    ...
    def __iter__(self) -> Iterator[asyncio.Task[None] | None]:  # type: ignore[return-value]
...
class ControlMessageCallback:
    ...
    def __init__(self, id: int | None, message: object | None = None) -> None:
    ...
    @classmethod
    def from_msg_id(cls, msg_id: int, **kwargs: object) -> ControlMessageCallback:
...
class PhoneAppStructs:
    ...
    headers: tuple[int, ...] = (0x13, 0xA3, 0x18)
