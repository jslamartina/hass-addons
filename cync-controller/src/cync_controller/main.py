...
uvloop: object | None = _uvloop


class UVLoopModule(Protocol):
    """Protocol for uvloop module functions used by the controller."""
...
g = GlobalObject()
__all__ = ["HAS_DOTENV", "CyncController", "dotenv", "main", "parse_cli"]
...
class CyncController:
    ...
    def __init__(self, *_args: object, **_kwargs: object) -> None:
        ...
        if uvloop is not None:
            loop_module = cast(UVLoopModule, uvloop)
            loop_module.install()
