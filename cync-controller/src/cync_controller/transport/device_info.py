...
class DeviceInfo:
    ...
    state: dict[str, object]  # Parsed state (on/off, brightness, color, etc.)
...
class MeshInfoRequestError(Exception):
    ...
    def __init__(self, reason: str, message: str) -> None:
        """Initialize mesh info request error."""
...
class DeviceInfoRequestError(Exception):
    ...
    def __init__(self, reason: str, message: str) -> None:
        """Initialize device info request error."""
        self.reason: str = reason
        self.message: str = message
        super().__init__(f"{reason}: {message}")
...
class DeviceStructParseError(Exception):
    ...
    def __init__(self, message: str) -> None:
        """Initialize device struct parse error."""
        self.message: str = message
