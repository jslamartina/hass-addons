...
from cync_controller.const import CYNC_CMD_BROADCASTS, FACTORY_EFFECTS_BYTES
from cync_controller.logging_abstraction import get_logger
from cync_controller.structs import ControlMessageCallback, FanSpeed, GlobalObject
...
class DeviceCommandsMixin:
    """Mixin class providing command methods for CyncDevice."""
    ...
    async def set_power(self, state: int):
        ...
        bridge_devices: list = ready_bridges + not_ready_bridges
