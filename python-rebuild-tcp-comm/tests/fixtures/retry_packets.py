...
RETRY_PAIRS = [
    RetryPacketPair(
        ...
        packet_type="0x73",
        original_hex="73 00 00 00 13 1b dc da 3e 00 00 00 7e 0d 01 00 00 f9 8e 01 00 00 8f 7e 7b 00 00 00 07 1b dc da 3e 00 13 00",
        retry_hex="73 00 00 00 13 1b dc da 3e 00 2c 00 7e 0d 01 00 00 f9 8e 01 00 00 8f 7e 7b 00 00 00 07 1b dc da 3e 00 13 00",
    ...
    RetryPacketPair(
        ...
        packet_type="0x73",
        original_hex="73 00 00 00 13 1b dc da 3e 00 00 00 7e 0d 01 00 00 f9 8e 01 00 00 8f 7e 7b 00 00 00 07 1b dc da 3e 00 13 00",
        retry_hex="73 00 00 00 13 1b dc da 3e 00 06 00 7e 0d 01 00 00 f9 8e 01 00 00 8f 7e 7b 00 00 00 07 1b dc da 3e 00 13 00",
        original_dedup_key="0x73:unknown:00:00:7e:7afb54622026a487",
    ...
    RetryPacketPair(
        ...
        packet_type="0x73",
        original_hex="73 00 00 00 13 1b dc da 3e 00 00 00 7e 0d 01 00 00 f9 8e 01 00 00 8f 7e 7b 00 00 00 07 1b dc da 3e 00 13 00",
        retry_hex="73 00 00 00 13 1b dc da 3e 00 05 00 7e 0d 01 00 00 f9 8e 01 00 00 8f 7e 7b 00 00 00 07 1b dc da 3e 00 13 00",
        original_dedup_key="0x73:unknown:00:00:7e:7afb54622026a487",
