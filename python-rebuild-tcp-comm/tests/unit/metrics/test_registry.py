...
class TestACKMetrics:
    ...
    def test_record_ack_received(self):
    ...
    def test_record_ack_timeout(self):
    ...
    def test_record_idempotent_drop(self):
    ...
    def test_record_message_abandoned(self):
...
class TestDedupCacheMetrics:
    ...
    def test_record_dedup_cache_size(self):
    ...
    def test_record_dedup_cache_hit(self):
    ...
    def test_record_dedup_cache_eviction(self):
...
class TestPerformanceMetrics:
    ...
    def test_record_state_lock_hold(self):
...
class TestDeviceOperationMetrics:
    ...
    def test_record_mesh_info_request(self):
    ...
    def test_record_device_info_request(self):
    ...
    def test_record_device_struct_parsed(self):
    ...
    def test_record_primary_device_violation(self):
