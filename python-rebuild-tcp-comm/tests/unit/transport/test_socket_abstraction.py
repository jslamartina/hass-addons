...
async def test_connect_success(tcp_connection: TCPConnection) -> None:
    ...
    with patch("asyncio.open_connection") as mock_open:
        ...
        assert tcp_connection._connected is True  # pyright: ignore[reportPrivateUsage]
...
async def test_connect_timeout(tcp_connection: TCPConnection) -> None:
    ...
    with patch("asyncio.open_connection") as mock_open:
        ...
        async def slow_connect(*_args: Any, **_kwargs: Any) -> tuple[AsyncMock, AsyncMock]:
...
async def test_send_success(tcp_connection: TCPConnection) -> None:
    ...
    tcp_connection._connected = True  # pyright: ignore[reportPrivateUsage]
...
async def test_send_not_connected(tcp_connection: TCPConnection) -> None:
    ...
    tcp_connection._connected = False  # pyright: ignore[reportPrivateUsage]
